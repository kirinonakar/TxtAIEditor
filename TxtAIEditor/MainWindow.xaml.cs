        ...
        public MainWindow()
        {
            ...
            _controllers = MainWindowCompositionRoot.Compose(
                ...
                new MainWindowCompositionRootCallbacks(
                    Operations.GetCurrentElementTheme,
                    Operations.GetLocalizedString,
                    Operations.UpdateWindowTitle,
                    Operations.ReloadTabWithEncodingAsync,
                    Operations.MarkTabDirtyFromStatusBar,
                    Operations.PerformLineNavigationAsync,
                    Operations.ToggleMaximize,
                    Operations.LoadFileIntoTabAsync,
                    Operations.LoadFileIntoTabAsync,
                    Operations.LoadFileIntoTabForAgentAsync,
                    Operations.UpdateRightPanelSelectionContext,
                    Operations.UpdateLivePreview,
                    Operations.UpdateLanguageUi,
                    Operations.SchedulePreview,
                    Operations.FocusSearchPanel,
                    Operations.EnsureLeftPanelVisible,
                    Operations.ShowLeftSidebarPage,
                    request => Operations.OpenNewTab(request),
                    () => Operations.OpenNewTab(),
                    Operations.OpenGeneratedTab,
                    Operations.OpenImageTab,
                    Operations.OpenPdfTab,
                    Operations.OpenOfficeDocumentTab,
                    Operations.CloseActiveTab,
                    Operations.SyncSnippetsToOpenEditorsAsync,
                    Operations.InitializePickerWindow,
                    Operations.GetAgentSessionEdits,
                    Operations.CloseTabAndCleanup,
                    Operations.CloseReadOnlyViewer,
                    Operations.SaveTabAsync,
                    Operations.GetPreviewBaseHref,
                    Operations.RefreshActivePreview,
                    Operations.LocalizeUi,
                    Operations.SyncAgentSettingsAfterLoad,
                    Operations.UpdateAutoSaveStatus,
                    Operations.GetSelectedExplorerItem,
                    Operations.SetCurrentRepoPath,
                    Operations.SetCurrentFolderPath,
                    () => Operations.IsStartupInitializationComplete,
                    Operations.OnGitFileRestored));
