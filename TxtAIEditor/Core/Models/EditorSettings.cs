...
namespace TxtAIEditor.Core.Models
{
    public class EditorSettings
    {
        ...
        public int StickyNoteWindowX { get; set; } = -1;
        public int StickyNoteWindowY { get; set; } = -1;
        ...
        public string LlmModelUpstage { get; set; } = "solar-pro4";
        ...
        public string LlmModelUnsloth { get; set; } = "";
