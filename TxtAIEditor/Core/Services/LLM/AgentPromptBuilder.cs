...
namespace TxtAIEditor.Core.Services.LLM
{
    public static class AgentPromptBuilder
    {
        public static string BuildSystemPrompt(string languageCode, bool isPlanningMode = false, string? targetLanguage = null)
        {
            ...
            builder.AppendLine("- Avoid replace_range for code edits. Use it only for user-selected text or generated documents when expectedSnippet is provided and exactly matches the full replaced block. Never make multiple replace_range edits in the same file without a fresh read.");
