...
namespace TxtAIEditor.Core.Services.LLM
{
    public static class AgentPromptBuilder
    {
            ...
            bool hasEnabledMcp = false)
        {
            ...
            builder.AppendLine("- Tool call examples vs live calls: When explaining, writing documentation, or showing tool call examples in prose or markdown code blocks, NEVER emit unescaped <tool_call> tags or live tool call JSON with real tool names. Use &lt;tool_call&gt;, \\<tool_call\\>, <tool_call_example>, or mock tool names (e.g. read_file_example) so examples are not misinterpreted as live tool calls. Only emit literal <tool_call> tags when you intend to execute a live tool call.");
