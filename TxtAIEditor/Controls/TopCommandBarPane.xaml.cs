...
namespace TxtAIEditor.Controls
{
    ...
    {
        private readonly TopCommandBarLayoutController _layoutController;

        public TopCommandBarPane()
        {
            InitializeComponent();
            _layoutController = new TopCommandBarLayoutController(
                TopCommandBar,
                LeftFileCommandPanel,
                GetToolbarButtonsById());
        }
        ...
        {
            _layoutController.ApplySettings(settings, getString);
        }
